...
m1 <- knn(train= Nursery_data.subset_train, test= Nursery_test.subset_test, cl= Nursery_data.subset_train_target, k= 95)
m1

#Make predictions on Nursery training and Nursery testing data 

train_predictions <- knn(train= Nursery_data.subset_train, test= Nursery_data.subset_train, cl= Nursery_data.subset_train_target, k=95)
test_predictions <- knn(train= Nursery_data.subset_train, test= Nursery_test.subset_test, cl= Nursery_data.subset_train_target, k=95)

#Calculate evaluation metrics for Nursery training data  

train_confusion <-confusionMatrix(train_predictions, Nursery_data.subset_train_target)
...
test_confusion <-confusionMatrix(test_predictions, Nursery_test.subset_test_target)
test_base_accuracy <- test_confusion$overall["Accuracy"]
test_base_sensitivity <- train_confusion$byclass["Sensitivity"]
test_base_recall <- test_confusion$byclass["Recall"]
test_base_f1 <- test_confusion$byclass["F1"]

# Confusion Matrix 
table(Nursery_test.subset_test_target, m1)
...
mode_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/mode_imputation_10.csv")
summary(mode_data)
summary(Nursery_test)
...
mode_data.subset=mode_data.subset[sample(1:nrow(mode_data.subset)), ]
str(mode_data.subset)

Nursery_test.subset <- Nursery_test[c('parents','has_nurs','form','children','housing','finance','social','health',  
                                      'class')]
head(Nursery_test.subset)
Nursery_test.subset=Nursery_test.subset[sample(1:nrow(Nursery_test.subset)), ]
str(Nursery_test.subset)
...
#Algorithm as m2 for knn

m2 <- knn(train= mode_data.subset_train, test= Nursery_test.subset_test, cl= mode_data.subset_train_target, k= 95)
m2
...
train_confusion <-confusionMatrix(train_predictions, mode_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m2)
...
mode2_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/mode_imputation_40.csv")
summary(mode2_data)
summary(Nursery_test)
...
mode2_data.subset=mode2_data.subset[sample(1:nrow(mode2_data.subset)), ]
...
m3 <- knn(train= mode2_data.subset_train, test= Nursery_test.subset_test, cl= mode2_data.subset_train_target, k= 95)
m3

#Make predictions on mode 40 and Nursery testing data

train_predictions <- knn(train= mode2_data.subset_train, test= Nursery_data.subset_train, cl= mode2_data.subset_train_target, k=95)
test_predictions <- knn(train= mode2_data.subset_train, test= Nursery_test.subset_test, cl= mode2_data.subset_train_target, k=95)

#Calculate evaluation metrics for mode 40 training data  

train_confusion <-confusionMatrix(train_predictions, mode2_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m3)
...
mode3_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/mode_imputation_70.csv")
summary(mode3_data)
summary(Nursery_test)
...
mode3_data.subset=mode3_data.subset[sample(1:nrow(mode3_data.subset)), ]
...
m4 <- knn(train= mode3_data.subset_train, test= Nursery_test.subset_test, cl= mode3_data.subset_train_target, k= 95)
m4

#Make predictions on mode 70 and Nursery testing data

train_predictions <- knn(train= mode3_data.subset_train, test= Nursery_data.subset_train, cl= mode3_data.subset_train_target, k=95)
test_predictions <- knn(train= mode3_data.subset_train, test= Nursery_test.subset_test, cl= mode3_data.subset_train_target, k=95)

#Calculate evaluation metrics for mode 70 training data  

train_confusion <-confusionMatrix(train_predictions, mode3_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m4)
...
nb_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/nb_imputation_10.csv")
summary(nb_data)
summary(Nursery_test)
...
nb_data.subset <- nb_data[c('parents','has_nurs','form','children','housing','finance','social','health',  
                                'class')]
head(nb_data.subset)
nb_data.subset=nb_data.subset[sample(1:nrow(nb_data.subset)), ]
str(nb_data.subset)
...
m5 <- knn(train= nb_data.subset_train, test= Nursery_test.subset_test, cl= nb_data.subset_train_target, k= 95)
m5

#Make predictions on nb 10 and Nursery testing data

train_predictions <- knn(train= nb_data.subset_train, test= Nursery_data.subset_train, cl= nb_data.subset_train_target, k=95)
test_predictions <- knn(train= nb_data.subset_train, test= Nursery_test.subset_test, cl= nb_data.subset_train_target, k=95)

#Calculate evaluation metrics for mode 70 training data  

train_confusion <-confusionMatrix(train_predictions, nb_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m5)
...
nb2_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/nb_imputation_40.csv")
summary(nb2_data)
summary(Nursery_test)
...
nb2_data.subset=mode_data.subset[sample(1:nrow(nb_data.subset)), ]
str(nb2_data.subset)
...
m6 <- knn(train= nb2_data.subset_train, test= Nursery_test.subset_test, cl=nb2_data.subset_train_target, k=95)
m6

#Make predictions on nb 40  and Nursery testing data

train_predictions <- knn(train= nb2_data.subset_train, test= Nursery_data.subset_train, cl= nb2_data.subset_train_target, k=95)
test_predictions <- knn(train= nb2_data.subset_train, test= Nursery_test.subset_test, cl= nb2_data.subset_train_target, k=95)

#Calculate evaluation metrics for mode 70 training data  

train_confusion <-confusionMatrix(train_predictions, nb2_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m6)
...
nb3_data <- read.csv("C:/Users/kebaabetswe.tlhoaele/OneDrive - Railway Safety Regulator/Documents/Post Graduate Diploma IE_Data Science/Post Block Assignment 3/nb_imputation_70.csv")
summary(nb3_data)
summary(Nursery_test)

# Remove the x column for the mode data and Nursery test

nb3_data.subset <- nb2_data[c('parents','has_nurs','form','children','housing','finance','social','health',  
                              'class')]
head(nb3_data.subset)
nb3_data.subset=mode_data.subset[sample(1:nrow(nb_data.subset)), ]
str(nb3_data.subset)
...
nb3_data.subset$class[is.na(nb3_data.subset$class)] <- "1"
nb3_data.subset$parents[is.na(nb3_data.subset$parents)] <- "3"
nb3_data.subset$has_nurs[is.na(nb3_data.subset$has_nurs)] <- "2"
nb3_data.subset$form[is.na(nb3_data.subset$form)] <- "1"
nb3_data.subset$housing[is.na(nb3_data.subset$housing)] <- "3"
nb3_data.subset$finance[is.na(nb3_data.subset$finance)] <- "2"
nb3_data.subset$social[is.na(nb3_data.subset$social)] <- "3"
nb3_data.subset$health[is.na(nb3_data.subset$health)] <- "2"
summary(nb3_data.subset)
...
m7 <- knn(train= nb3_data.subset_train, test= Nursery_test.subset_test, cl=nb3_data.subset_train_target, k=95)
m7

#Make predictions on nb 70  and Nursery testing data

train_predictions <- knn(train= nb3_data.subset_train, test= Nursery_data.subset_train, cl= nb3_data.subset_train_target, k=95)
test_predictions <- knn(train= nb3_data.subset_train, test= Nursery_test.subset_test, cl= nb3_data.subset_train_target, k=95)

#Calculate evaluation metrics for mode 70 training data  

train_confusion <-confusionMatrix(train_predictions, nb3_data.subset_train_target)
train_base_accuracy <-train_confusion$overall["Accuracy"]
train_base_sensitivity <-train_confusion$byclass["Sensitivity"]
train_base_recall <- train_confusion$byclass["Recall"]
train_base_f1 <- train_confusion$byclass["F1"]
...
table(Nursery_test.subset_test_target, m7)
