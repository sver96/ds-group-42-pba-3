...
# Load dataset
file_path = r"C:\Users\difedile.rasenyalo\OneDrive - DSV\Stellenbosch\Post block Assignment3\train_data_70.csv"
...
data_imputed.to_csv("mean_imputed_data_70.csv", index=False)

print("DataFrame with mean imputed values exported to mean_imputed_data_70.csv")
