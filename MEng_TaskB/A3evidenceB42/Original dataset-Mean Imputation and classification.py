...
# Load dataset
file_path = r"C:\Users\difedile.rasenyalo\OneDrive - DSV\Stellenbosch\Post block Assignment3\train_data_control.xlsx"
...
# Model the orginal data set before imputing 
...
sns.heatmap(cm, annot=True, cmap='Oranges', fmt='d', xticklabels=classes, yticklabels=classes, cbar=False, annot_kws={"color": 'black'})
